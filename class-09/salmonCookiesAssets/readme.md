...
- Style up the public facing page (**index.html**) to make it appealing to customers. NOTE: You **must** use all of the images in the `class-09/lab-b/assets/` directory in the class repository. Your client insists that you use Every. Single. One.
